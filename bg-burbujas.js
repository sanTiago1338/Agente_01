...
(function () {
  ...
  css.textContent = [
    ...
    '    radial-gradient(circle at 50% 50%, rgba(var(--c),.035) 44%, rgba(var(--c),.14) 74%, rgba(var(--c),.30) 93%, rgba(var(--c),.09) 100%);',
    '  box-shadow:',
    '    inset 0 0 0 1px rgba(var(--c),.34),',
    '    inset calc(var(--s) * .05) calc(var(--s) * .06) calc(var(--s) * .14) rgba(255,255,255,.65),',
    '    inset calc(var(--s) * -.04) calc(var(--s) * -.05) calc(var(--s) * .12) rgba(var(--c),.18),',
    '    0 calc(var(--s) * .07) calc(var(--s) * .20) rgba(20,22,26,.10);',
